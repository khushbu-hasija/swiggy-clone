  ...
  return ({ restaurantInfo }) => {
    return (
      <div className="relative">
        ...
        <div className="absolute left-0 top-4 z-10 rounded-r-lg bg-linear-to-r from-orange-500 to-red-500 px-4 py-2 text-xs font-bold uppercase tracking-wider text-white shadow-lg">
          Promoted
        </div>
